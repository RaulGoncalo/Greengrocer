...
import 'package:quitanda/src/pages/base/home/components/category_tile.dart';
import 'package:quitanda/src/config/custom_colors.dart';
import 'package:quitanda/src/pages/base/home/components/item_tile.dart';
...
class _HomeTabState extends State<HomeTab> {
  String selectedCategory = 'Legumes';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: AddToCartAnimation(
        ...
        previewCurve: Curves.easeInBack,
                  ...
                  ? ListView.separated(
                      ...
                      itemBuilder: (_, index) {
                        return CategoryTile(
                          ...
                          categorie: app_data.categories[index],
                          isSelected:
                              selectedCategory == app_data.categories[index],
                        );
                      },
